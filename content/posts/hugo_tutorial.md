...
After doing that, create a `pages.yml` file under `.github/workflows` folder (create the folder and sub-folder if necessary).

> NOTE: make sure to include the "." before github in the `.github/workflows` folder. 

Copy the following lines inside the `pages.yml` file:
